 ...
 */
public class CroquisEdgeEffect {
     ...
     */
    public CroquisEdgeEffect(Context context) {
        final Resources res = context.getResources();
        mEdge = res.getDrawable(com.croquis.list.sample10.R.drawable.overscroll_edge/*!R.drawable.overscroll_edge!*/);
        mGlow = res.getDrawable(com.croquis.list.sample10.R.drawable.overscroll_glow/*!R.drawable.overscroll_glow!*/);
