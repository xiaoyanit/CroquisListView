...
public abstract class CroquisAbsListView extends CroquisAdapterView<ListAdapter> implements TextWatcher,
     ...
     */
    private CroquisEdgeGlow mEdgeGlowTop;

    /**
     * Tracks the state of the bottom edge glow.
     */
    private CroquisEdgeGlow mEdgeGlowBottom;
    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                final Drawable edge = res.getDrawable(yourapp.R.drawable.overscroll_edge/*!R.drawable.overscroll_edge!*/);
                final Drawable glow = res.getDrawable(yourapp.R.drawable.overscroll_glow/*!R.drawable.overscroll_glow!*/);
                mEdgeGlowTop = new CroquisEdgeGlow(edge, glow);
                mEdgeGlowBottom = new CroquisEdgeGlow(edge, glow);
            }
        } else {
            mEdgeGlowTop = null;
