...
public class CroquisEdgeEffect {
    ...
    public CroquisEdgeEffect(Context context) {
        ...
        mEdge = res.getDrawable(yourapp.R.drawable.overscroll_edge/*!R.drawable.overscroll_edge!*/);
        mGlow = res.getDrawable(yourapp.R.drawable.overscroll_glow/*!R.drawable.overscroll_glow!*/);
