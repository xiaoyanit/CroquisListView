 ...
 */
public class CroquisOverScroller {
    private int mMode;
     ...
     * @param context
     */
    public CroquisOverScroller(Context context) {
        this(context, null);
    }
     ...
     * be used.
     */
    public CroquisOverScroller(Context context, Interpolator interpolator) {
     ...
     * @hide
     */
    public CroquisOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
            ...
            case SCROLL_MODE:
                ...
                if (elapsedTime < duration) {
                    ...
                    if (mInterpolator == null) {
                        q = CroquisFakeViewGroup.viscousFluid(q);//!Scroller.viscousFluid(q);
                    } else {
