...
public abstract class CroquisAbsListView extends CroquisAdapterView<ListAdapter> implements TextWatcher,
     ...
     */
    private CroquisEdgeEffect mEdgeGlowTop;

    /**
     * Tracks the state of the bottom edge glow.
     */
    private CroquisEdgeEffect mEdgeGlowBottom;
    ...
    private void initAbsListView() {
        ...
        mOverscrollDistance = (int) (density * 0 + 0.5f);//!configuration.getScaledOverscrollDistance();
        mOverflingDistance = (int) (density * 4 + 0.5f);//!configuration.getScaledOverflingDistance();
    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                mEdgeGlowTop = new CroquisEdgeEffect(context);
                mEdgeGlowBottom = new CroquisEdgeEffect(context);
            }
        } else {
            mEdgeGlowTop = null;
    ...
    protected boolean isPaddingOffsetRequired() {
        return true;//!(mGroupFlags & CLIP_TO_PADDING_MASK) != CLIP_TO_PADDING_MASK;
    }
    ...
    protected int getRightPaddingOffset() {
        return /*!(mGroupFlags & CLIP_TO_PADDING_MASK) == CLIP_TO_PADDING_MASK ? 0 :!*/ getPaddingRight();
    }

    @Override
    protected int getBottomPaddingOffset() {
        return /*!(mGroupFlags & CLIP_TO_PADDING_MASK) == CLIP_TO_PADDING_MASK ? 0 :!*/ getPaddingBottom();
    }
    ...
    public boolean showContextMenu(float x, float y, int metaState) {
        ...
        if (position != INVALID_POSITION) {
            ...
            if (child != null) {
                ...
                return super.showContextMenuForChild(CroquisAbsListView.this);
            }
        }
    ...
    private class FlingRunnable implements Runnable {
         ...
         */
        private final CroquisOverScroller mScroller;
        ...
        private final Runnable mCheckFlywheel = new Runnable() {
            public void run() {
                ...
                final CroquisOverScroller scroller = mScroller;
        ...
        FlingRunnable() {
            mScroller = new CroquisOverScroller(getContext());
        }
    ...
    class AdapterDataSetObserver extends CroquisAdapterView<ListAdapter>.AdapterDataSetObserver {
        /*!
        @Override
    ...
    class RecycleBin {
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    final CroquisAbsListView.LayoutParams lp
                            = (CroquisAbsListView.LayoutParams) victim.getLayoutParams();
    ...
    static View retrieveFromScrap(ArrayList<View> scrapViews, int position) {
        ...
        if (size > 0) {
            ...
            for (int i=0; i<size; i++) {
                ...
                if (((CroquisAbsListView.LayoutParams)view.getLayoutParams())
